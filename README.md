...
- [Subscribing options](#subscribing-options---the-5th-argument): [Direct topic subscriptions](#direct-subscriptions); [Queue consume](#queue-consume); [Browsing a queue](#browsing-a-queue)
