...
# Load into Docker Images with: docker load -i solace-pretty-dump-docker-1.1.1.tar.gz
#
# To RUN:
#
...
#     2) docker build -t solace-pretty-dump:latest -t solace-pretty-dump:1.1.1 --file Dockerfile .
#
