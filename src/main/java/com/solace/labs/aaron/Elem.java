...
//		defaults.put(FLOAT, new Col(214));
		...
		map.put(BYTES, new Col(87));
		map.put(BYTES_CHARS, new Col(99));
...
//		map.put(FLOAT, new Col(142));
		...
		map.put(BYTES, new Col(33));
		map.put(BYTES_CHARS, new Col(92));
